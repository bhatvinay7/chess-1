    ...
    <div ref={ref} style={s.root}>
      <div style={s.toggleRow}>
        ...
        <button
          ...
          aria-label={darkUI ? "Switch to light mode" : "Switch to dark mode"}
        >
  ...
  return {
    root: {
      ...
      boxShadow: dark
        ...
        : "0 18px 48px rgba(28,45,35,0.14)",
    ...
    toggleThumb: {
      position: "absolute",
      top: "50%",
      left: dark ? "calc(100% - 18px)" : "3px",
      transform: "translateY(-50%)",
      width: "14px",
      height: "14px",
      borderRadius: "50%",
      background: dark ? "#aad48a" : "#fff",
