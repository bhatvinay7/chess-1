...
export default function TimeController({
  ...
  return (
    <div style={st.root}>
        ...
        <>
          ...
          <div style={st.selectedBadge}>
            ...
            <span style={st.selectedBadgeText}>
              {group?.options.find((v) => v.value === time_slot.value)?.value ??
                "10 min"}{" "}
          ...
          <div style={{ marginBottom: "0.65rem" }}>
            <div
              style={{
                ...
                color: darkUI ? "rgba(200,230,200,0.45)" : "#666",
                marginBottom: "0.4rem",
              }}
            >
              Game Type
            ...
            <label style={st.toggle}>
              ...
              <span
                style={{
                  ...st.toggleSlider,
                  background: isRated
                    ? "rgba(129,182,76,0.45)"
                    : "rgba(124,163,95,0.15)",
                  borderColor: isRated
                    ? "rgba(129,182,76,0.6)"
                    : "rgba(124,163,95,0.2)",
                }}
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          if (!active) {
                            ...
                            ).style.background = darkUI
                              ? "rgba(124,163,95,0.08)"
                              : "rgba(0,0,0,0.13)";
          ...
          <div style={st.secondaryBtns}>
            <button type="button" style={st.secondaryBtn}>
              ⚙ Custom Challenge
            </button>
            <button type="button" style={st.secondaryBtn}>
              🤝 Play a Friend
      ...
      {activeTab === "Games" && <GamesTab dark={darkUI} />}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: "0.62rem", color: textFaint }}>
                    {black.rating}
                  </span>
                </div>
